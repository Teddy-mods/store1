...
def start(update: Update, context: CallbackContext):
    ...
    if check_status(user_id):
        ...
        keyboard = [[
            InlineKeyboardButton(f'💳 Comprar', callback_data='m1'), 
            InlineKeyboardButton(f'💵 Adicionar saldo', callback_data='adicionar_saldo')],
            [InlineKeyboardButton(f'📄 Informações', callback_data='m2'),
            InlineKeyboardButton(f'🔧 Desenvolvedor', url='https://t.me/pladixoficial')],]
        ...
        if asyncio.run(check_config('afiliado'))[1] == '1':
            ...
            keyboard.append([InlineKeyboardButton(f'☎️ Suporte', url='https://t.me/{}'.format(str(support().replace('@', ''))))])
        ...
        keyboard2 = [[InlineKeyboardButton(f'💙 Aceitar os termos de compra', callback_data='termos'),]]
